...
from src.data import parse_episodes, collate_fn_train,parse_test
import os
...
parser.add_argument("--loss", type=str, default="atloss", help="learning rate")
...
indomain_test_episodes = parse_test("data/test_docred.json", tokenizer, K=args.support_docs_eval, n_queries=args.query_docs_eval, n_samples=5000, markers=args.use_markers, balancing=args.balancing_eval, seed=123, ensure_positive=False, cache="cache/")
scierc_test_episodes = parse_test("data/test_scierc.json", tokenizer, K=args.support_docs_eval, n_queries=args.query_docs_eval, n_samples=1000, markers=args.use_markers, balancing=args.balancing_eval, seed=123, ensure_positive=False, cache="cache/")
# %%
